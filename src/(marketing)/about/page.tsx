...
const flow = [
	...
	<>Data merged (<code class="px-1 rounded bg-slate-900/5 dark:bg-white/10">{'{ ...server, ...client }'}</code>), injected as <code class="px-1 rounded bg-slate-900/5 dark:bg-white/10">globalThis.__SSR__</code>.</>,
