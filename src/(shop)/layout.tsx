...
const Layout: Stateful<Args, 'section'> = function* (args) {
  ...
  try {
    ...
    while (true) {
      ...
      yield (
        <>
          <div class="relative overflow-hidden panel px-5 py-4 border-emerald-600/25 dark:border-emerald-400/25 bg-gradient-to-r from-emerald-500/10 via-emerald-500/5 to-transparent dark:from-emerald-600/15 dark:via-emerald-500/10">
            <div class="absolute inset-0 pointer-events-none">
              <div class="absolute -inset-px opacity-25 dark:opacity-30 bg-[radial-gradient(circle_at_85%_35%,rgba(16,185,129,.35),transparent_60%)]" />
            </div>
            <div class="relative flex items-center justify-between gap-6 flex-wrap">
              ...
              <div class="flex items-center gap-4">
                <div class="flex items-center gap-2 text-xs font-medium text-emerald-800 dark:text-emerald-200/90 bg-emerald-600/10 dark:bg-black/30 rounded-md p-1 ring-1 ring-emerald-600/30 dark:ring-emerald-400/25">
                ...
                {path !== '/checkout' && (
                  <a href="/checkout" class="text-xs px-3 py-1 rounded-md bg-emerald-600/15 hover:bg-emerald-600/25 text-emerald-800 dark:bg-emerald-500/25 dark:hover:bg-emerald-500/35 dark:text-emerald-100 font-medium transition ring-1 ring-emerald-600/30 dark:ring-emerald-400/30">Checkout</a>
                )}
              </div>
            </div>
          </div>
