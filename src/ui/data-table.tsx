...
const classes: BaseDataTableClasses<any> = {
	...
	columnsTrigger: 'inline-flex h-8 items-center gap-2 rounded-md edge bg-transparent px-3 text-sm font-medium shadow-xs transition-all outline-none hover:bg-accent hover:text-accent-foreground focus-visible:ring-3 focus-visible:ring-ring/50',
	emptyCell: 'h-24 text-center text-muted-foreground',
	facetCount: 'rounded bg-muted px-1.5 py-0.5 text-xs tabular-nums',
	facetIcon: 'i-lucide-list-filter size-4',
	facetOptionIcon: 'size-4',
	facetTrigger: 'inline-flex h-8 items-center gap-2 rounded-md border border-dashed bg-transparent px-3 text-sm font-medium shadow-xs transition-all outline-none hover:bg-accent hover:text-accent-foreground focus-visible:ring-3 focus-visible:ring-ring/50',
